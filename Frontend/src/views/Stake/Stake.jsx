...
function Stake() {
  ...
  return (
    <div id="stake-view">
      <div id="stake" className="tab-pane fade stake-body">
        <div className="apy">
          <div className="item">
            <h2>APY</h2>
            {stakingAPY ? (
              <h3>{new Intl.NumberFormat("en-US").format(trimmedStakingAPY)}%</h3>
            ) : (
              <Skeleton width="150px" />
            )}
          </div>
          <div className="item">
            <h2>Time until rebase</h2>
            <RebaseTimer />
          </div>
        </div>
        <div className="stake-inner-tab">
          ...
          <div className="tab-content">
            {!address ? (
              ...
              <div id="stake" className="tab-pane fade in active">
                <div className="amount">
                  <h3>Amount</h3>
                  <form action="">
                    <input type="text" name="" placeholder="0" className="field" />
                ...
                <div className="balance">
                  <div className="item">
                    ...
                    <p className="value">
                      {isAppLoading ? <Skeleton className="detail-value" /> : <>{trim(ohmBalance, 4)} OHM</>}
                    </p>
                  </div>
                  <div className="item">
                    <p className="label">Staked</p>
                    <p className="value">
                      {isAppLoading ? <Skeleton className="detail-value" /> : <>{trimmedBalance} sOHM</>}
                    </p>
                  </div>
                  <div className="item">
                    <p className="label">Next reward amount</p>
                    <p className="value">
                      {isAppLoading ? <Skeleton className="detail-value" /> : <>{nextRewardValue} sOHM</>}
                    </p>
                  </div>
                  <div className="item">
                    <p className="label">Next rebase yield</p>
                    <p className="value">
                      {isAppLoading ? <Skeleton className="detail-value" /> : <>{stakingRebasePercentage} sOHM</>}
                    </p>
                  </div>
                  <div className="item">
                    <p className="label">ROI (5-day rate)</p>
                    <p className="value">
                      {isAppLoading ? <Skeleton className="detail-value" /> : <>{trim(fiveDayRate * 100, 4)}%</>}
                    </p>
                  </div>
                </div>
                <div className="stake_btn">
                  <button type="button" disabled="disabled" className="disabled">
                    Stake
                  </button>
                </div>
              </div>
